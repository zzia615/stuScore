        ...
        <table>
            <tr>
                <td style="width: 100px">
                    <asp:LinkButton ID="lnkScIn" runat="server" PostBackUrl="~/scoreIn.aspx">插入成绩信息</asp:LinkButton></td>
            ...
            <tr>
                <td style="width: 100px">
                    <asp:LinkButton ID="lnkScUp" runat="server" PostBackUrl="~/scoreUp.aspx">修改成绩信息</asp:LinkButton></td>
            </tr>
            <tr>
                <td style="width: 100px">
                    <asp:LinkButton ID="lnkScDe" runat="server" PostBackUrl="~/scoreDe.aspx">删除成绩信息</asp:LinkButton></td>
            </tr>
            <tr>
                <td style="width: 100px">
