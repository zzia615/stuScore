...
public partial class classDe : System.Web.UI.Page
{
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string strDel = "select * from class where class_id=" + DropDownList1.SelectedValue;
        ...
        da.Fill(ds, "class");
        conn.Close();
        Label1.Text = ds.Tables["class"].Rows[0][1].ToString();
        
    }
    protected void btnOk_Click(object sender, EventArgs e)
    {
        string StrDelete = "delete from class where class_id=" + DropDownList1.SelectedValue;
        db dbom = new db();
